...
class TaskAdapter_Tela_CL_1(private val tasks: List<Task_CL_1>) : RecyclerView.Adapter<TaskAdapter_Tela_CL_1.TaskViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.activity_tela_cl1_list_item_task, parent, false)
