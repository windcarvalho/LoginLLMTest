...
public class TaskAdapterAccess_Tela_3 extends ArrayAdapter<Task_Tela_3> {

    public TaskAdapterAccess_Tela_3(@NonNull Context context, @NonNull List<Task_Tela_3> tasks) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.activity_tela_access_3_list_item_task, parent, false);
        }
        ...
        // Definindo rótulo acessível para a checkbox
        checkBox.setContentDescription(currentTask.getTask());
